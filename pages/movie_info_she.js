...
import Movie_info_she_css from '../component/movie_info_frozen_css'
import Head from 'next/head'

const movie_info_she=()=>{
    return(
        <div>
            <Head>
                <title>
            ...
            <div class="body_movie_info">
                <div class="movie_info">
                    <div class="info">
                        <h1>영화 상세</h1>
                        <img class="movie_img" src="/she.jpeg" alt=""/>
                        <div class="title">
                            <p class="movie_name">감쪽같은 그녀</p>
